...
This file is a copy of `AGENTS.md`. Both files contain identical instructions — one for opencode (`AGENTS.md`), one for Claude Code (`CLAUDE.md`). Edit both when updating.
