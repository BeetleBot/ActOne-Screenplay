...
The app uses 5 sub-windows: `settings`, `help`, `theme-manager`, `xray`, `tutorials`. They are created via `useModalWindows` hook as standalone Tauri `WebviewWindow` instances.
