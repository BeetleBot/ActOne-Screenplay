...
export const FOUNTAIN_SYNTAX_RULES = [
  ...
  "9. Punctuation Rules (No EmDashes):",
  "   - Do NOT use EmDashes (—) under any circumstances in generated or rephrased text. Use double hyphens (--) or single hyphens instead.",
