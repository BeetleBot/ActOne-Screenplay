...
export const DEFAULTS: Record<string, string | number | boolean | string[]> = {
  ...
  [STORAGE_KEYS.SHOW_TIMELINE]: true,
  [STORAGE_KEYS.TIMELINE_SHOW_SECTIONS]: false,
  [STORAGE_KEYS.TIMELINE_SHOW_SCENE_NUMBERS]: true,
  [STORAGE_KEYS.TIMELINE_SHOW_SCENE_COLORS]: true,
